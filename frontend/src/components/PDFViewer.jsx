...
export default function PDFViewer({ url }) {
  ...
  return (
    <div className="flex flex-col items-center bg-stone-900/80 rounded-xl overflow-hidden shadow-2xl h-full border border-white/10">
      
      {/* Controles do PDF */}
      <div className="flex items-center justify-between w-full p-4 bg-stone-800 border-b border-white/10">
        <div className="flex gap-2">
          ...
          <span className="px-4 py-2 text-xs font-bold text-stone-300 bg-stone-900 rounded-lg border border-white/5">
        ...
        <div className="flex gap-2">
          ...
          <span className="px-3 py-2 text-xs font-bold text-stone-300 bg-transparent flex items-center">
      ...
      {/* Renderização do PDF */}
      <div className="flex-1 overflow-auto w-full custom-scrollbar p-6 bg-stone-950 flex justify-center items-start">
        <Document
          file={url}
